...
import { external, globals, plugins as pluginsPromise } from 'adminjs/bundler';
...
async function build({
  ...
  const plugins = await pluginsPromise({ babelConfig, minify, commonJSConfig });
  plugins.push(pluginImage());
